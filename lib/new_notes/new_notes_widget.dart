...
class NewNotesWidget extends StatefulWidget {
  const NewNotesWidget({super.key});

  static String routeName = 'newNotes';
  static String routePath = '/newNotes';
...
class _NewNotesWidgetState extends State<NewNotesWidget> {
  ...
  void initState() {
    ...
    _model.notepadTextController ??= TextEditingController();
    _model.notepadFocusNode ??= FocusNode();
                      ...
                      onPressed: () async {
                        ...
                        await NotesRecord.collection
                            ...
                            .set(createNotesRecordData(
                              ...
                              matter: _model.notepadTextController.text,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    width: double.infinity,
                    child: TextFormField(
                      controller: _model.notepadTextController,
                      focusNode: _model.notepadFocusNode,
                      autofocus: false,
                      enabled: true,
                      obscureText: false,
                      decoration: InputDecoration(
                      ...
                      cursorColor: FlutterFlowTheme.of(context).primaryText,
                      enableInteractiveSelection: true,
                      validator: _model.notepadTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
