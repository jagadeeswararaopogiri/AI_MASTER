...
import '/index.dart';
import 'lesson_copy_widget.dart' show LessonCopyWidget;
...
class LessonCopyModel extends FlutterFlowModel<LessonCopyWidget> {
  ...
  // Stores action output result for [Backend Call - API (GenerateLessonContent Copy)] action in Button widget.
  ApiCallResponse? apiResult021222;
