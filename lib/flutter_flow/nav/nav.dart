...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: NewTaskWidget.routeName,
          path: NewTaskWidget.routePath,
          builder: (context, params) => NewTaskWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: LessonWidget.routeName,
          path: LessonWidget.routePath,
        ...
        FFRoute(
          name: AllNotesWidget.routeName,
          path: AllNotesWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AllNotes')
              : AllNotesWidget(),
        ),
        FFRoute(
          name: NewNotesWidget.routeName,
          path: NewNotesWidget.routePath,
          builder: (context, params) => NewNotesWidget(),
        ),
        FFRoute(
          name: EditNotesWidget.routeName,
          path: EditNotesWidget.routePath,
          builder: (context, params) => EditNotesWidget(
            notesRef: params.getParam(
              'notesRef',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: LessonCopyWidget.routeName,
          path: LessonCopyWidget.routePath,
          builder: (context, params) => LessonCopyWidget(
            taskDocRef: params.getParam(
              'taskDocRef',
              ParamType.DocumentReference,
              isList: false,
