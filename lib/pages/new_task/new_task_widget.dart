...
class NewTaskWidget extends StatefulWidget {
  ...
  static String routePath = '/newTask';
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<int>(
      ...
      builder: (context, snapshot) {
        ...
        int newTaskCount = snapshot.data!;
                  ...
                  children: [
                    ...
                    if (newTaskCount <= 0)
                      FFButtonWidget(
                        onPressed: () async {
                          _model.apiResulthdj =
                              await GenerateStydyPlannerCall.call(
                            subject: _model.textController1.text,
                            hours: _model.textController2.text,
                            level: _model.dropDownValue,
                          );

                          if ((_model.apiResulthdj?.succeeded ?? true)) {
                            _model.rawtextData = getJsonField(
                              (_model.apiResulthdj?.jsonBody ?? ''),
                              r'''$.candidates[0].content.parts[0].text''',
                            ).toString();
                            safeSetState(() {});
                            if (_model.rawtextData != null &&
                                _model.rawtextData != '') {
                              _model.jsonLessonsData =
                                  functions.parseGeminiJson(_model.rawtextData);
                              safeSetState(() {});
                              if (_model.jsonLessonsData != null) {
                                ...
                                _model.firstDay = await queryTasksRecordOnce(
                                ...
                                await _model.firstDay!.reference
